...
(function(window) {
    ...
    /**
     * Constructor of ComputerVisionariesReg object,
     ...
     */
    webgazer.reg.ComputerVisionariesReg.prototype.addData = function(eyes, screenPos, type) {
        if (!eyes) {
            return;
        }
     ...
     * @returns {Object}
     */
    webgazer.reg.ComputerVisionariesReg.prototype.predict = function(eyesObj) {
     ...
     */
    webgazer.reg.ComputerVisionariesReg.prototype.setData = function(data) {
     ...
     */
    webgazer.reg.ComputerVisionariesReg.prototype.getData = function() {
        return this.dataClicks.data.concat(this.dataTrail.data);
    }
    
    /**
     * The ComputerVisionariesReg object name
     * @type {string}
     */
    webgazer.reg.ComputerVisionariesReg.prototype.name = 'computerVisionaries';
